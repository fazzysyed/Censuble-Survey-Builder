...
class Answer extends React.Component {
  ...
  handleSelectionMultiple = async (item) => {
    ...
    if (selectedIds.includes(item.answer_id))
      selectedIds = selectedIds.filter((_id) => _id !== item.answer_id);
    
      
    else selectedIds.push(item.answer_id);
    ...
    return (
      <div
        ...
        {this.props.answerTypes.map((item) => (
            ...
            //      textAlign: 'center',
            //      alignItems: 'center',
            //      backgroundColor: this.state.selectedIds.includes(item.answer_id)
            //        ? '#114B78'
            //        : '#FFFFFF',
            //      borderColor: '#AFAFAF',
            //      borderRadius: 4,
            ...
            //        color: this.state.selectedIds.includes(item.answer_id)
            //          ? '#FFFFFF'
            //          : '#000',
            //      }}>
            //      {item.answer}
